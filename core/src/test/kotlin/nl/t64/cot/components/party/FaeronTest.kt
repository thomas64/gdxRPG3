...
internal class FaeronTest : GameTest() {

    @Test
    fun whenHeroesAreCreated_FaeronShouldHaveRightStats() {
        val faeron = HeroContainer().getCertainHero("faeron")
        ...
        assertThat(faeron.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(25)
        assertThat(faeron.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(25)
