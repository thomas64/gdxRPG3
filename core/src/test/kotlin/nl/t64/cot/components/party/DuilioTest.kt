...
internal class DuilioTest : GameTest() {

    @Test
    fun whenHeroesAreCreated_DuilioShouldHaveRightStats() {
        val duilio = HeroContainer().getCertainHero("duilio")
        ...
        assertThat(duilio.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(25)
        assertThat(duilio.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(25)
