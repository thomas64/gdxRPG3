...
internal class IellwenTest : GameTest() {
    ...
    fun whenHeroesAreCreated_IellwenShouldHaveRightStats() {
        ...
        assertThat(iellwen.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(30)
        assertThat(iellwen.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(30)
