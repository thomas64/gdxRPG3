...
internal class LuthaisTest : GameTest() {
    ...
    fun whenHeroesAreCreated_LuthaisShouldHaveRightStats() {
        ...
        assertThat(luthais.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(18)
        assertThat(luthais.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(18)
