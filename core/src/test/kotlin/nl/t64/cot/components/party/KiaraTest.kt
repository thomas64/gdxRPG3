...
internal class KiaraTest : GameTest() {

    @Test
    fun whenHeroesAreCreated_KiaraShouldHaveRightStats() {
        val kiara = HeroContainer().getCertainHero("kiara")
        ...
        assertThat(kiara.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(20)
        assertThat(kiara.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(20)
