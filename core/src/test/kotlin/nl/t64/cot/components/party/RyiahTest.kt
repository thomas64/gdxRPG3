...
internal class RyiahTest : GameTest() {

    @Test
    fun whenHeroesAreCreated_RyiahShouldHaveRightStats() {
        val ryiah = HeroContainer().getCertainHero("ryiah")
        ...
        assertThat(ryiah.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(16)
        assertThat(ryiah.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(16)
