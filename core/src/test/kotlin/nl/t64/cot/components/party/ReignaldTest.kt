...
internal class ReignaldTest : GameTest() {

    @Test
    fun whenHeroesAreCreated_ReignaldShouldHaveRightStats() {
        val reignald = HeroContainer().getCertainHero("reignald")
        ...
        assertThat(reignald.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(20)
        assertThat(reignald.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(20)
