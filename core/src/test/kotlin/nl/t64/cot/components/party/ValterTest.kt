...
internal class ValterTest : GameTest() {
    ...
    fun whenHeroesAreCreated_ValterShouldHaveRightStats() {
        ...
        assertThat(valter.getStatById(StatItemId.CONSTITUTION).rank).isEqualTo(15)
        assertThat(valter.getCalculatedTotalStatOf(StatItemId.CONSTITUTION)).isEqualTo(15)
