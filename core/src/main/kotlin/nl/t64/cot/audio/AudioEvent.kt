...
enum class AudioEvent(val filePath: String, val volume: Float = 1f) {
    ...
    SE_STEP_CARPET3("audio/se/footsteps/oot_step_carpet3.wav", 0.9f),
    SE_STEP_CARPET4("audio/se/footsteps/oot_step_carpet4.wav", 0.9f),
    SE_STEP_CARPET5("audio/se/footsteps/oot_step_carpet5.wav", 0.9f),

    SE_STEP_GRASS1("audio/se/footsteps/oot_step_grass1.wav", 0.9f),
    SE_STEP_GRASS2("audio/se/footsteps/oot_step_grass2.wav", 0.9f),
    SE_STEP_GRASS3("audio/se/footsteps/oot_step_grass3.wav", 0.9f),
    SE_STEP_GRASS4("audio/se/footsteps/oot_step_grass4.wav", 0.9f),
    SE_STEP_GRASS5("audio/se/footsteps/oot_step_grass5.wav", 0.9f),
    SE_STEP_GRASS6("audio/se/footsteps/oot_step_grass6.wav", 0.9f),
    SE_STEP_GRASS7("audio/se/footsteps/oot_step_grass7.wav", 0.9f),

    SE_STEP_SAND1("audio/se/footsteps/oot_step_sand1.wav", 0.9f),
    SE_STEP_SAND2("audio/se/footsteps/oot_step_sand2.wav", 0.9f),
    SE_STEP_SAND3("audio/se/footsteps/oot_step_sand3.wav", 0.9f),
    SE_STEP_SAND4("audio/se/footsteps/oot_step_sand4.wav", 0.9f),
    SE_STEP_SAND5("audio/se/footsteps/oot_step_sand5.wav", 0.9f),

    SE_STEP_STONE1("audio/se/footsteps/oot_step_stone1.wav", 0.9f),
    SE_STEP_STONE2("audio/se/footsteps/oot_step_stone2.wav", 0.9f),
    SE_STEP_STONE3("audio/se/footsteps/oot_step_stone3.wav", 0.9f),
    SE_STEP_STONE4("audio/se/footsteps/oot_step_stone4.wav", 0.9f),
    SE_STEP_STONE5("audio/se/footsteps/oot_step_stone5.wav", 0.9f),
    SE_STEP_STONE6("audio/se/footsteps/oot_step_stone6.wav", 0.9f),

    SE_STEP_WATER1("audio/se/footsteps/oot_step_water1.wav", 0.9f),
    SE_STEP_WATER2("audio/se/footsteps/oot_step_water2.wav", 0.9f),
    SE_STEP_WATER3("audio/se/footsteps/oot_step_water3.wav", 0.9f),
    SE_STEP_WATER4("audio/se/footsteps/oot_step_water4.wav", 0.9f),

    SE_STEP_WOOD1("audio/se/footsteps/oot_step_wood1.wav", 0.9f),
    SE_STEP_WOOD2("audio/se/footsteps/oot_step_wood2.wav", 0.9f),
    SE_STEP_WOOD3("audio/se/footsteps/oot_step_wood3.wav", 0.9f),
    SE_STEP_WOOD4("audio/se/footsteps/oot_step_wood4.wav", 0.9f),
    SE_STEP_WOOD5("audio/se/footsteps/oot_step_wood5.wav", 0.9f),
