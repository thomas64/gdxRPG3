...
class AlvaTraveler : EntitySchedule() {
    ...
    override val scheduleParts: List<SchedulePart> = listOf(
        ...
        SchedulePart("alva_road_west", "09:04", "09:19", WEST,  IDLE,    "alva_traveler4", "alva_traveler4", "alva_traveler_waiting"),
        SchedulePart("alva_road_west", "09:19", "09:20", EAST,  WALKING, "alva_traveler4", "alva_traveler3"),
        SchedulePart("alva_road_west", "09:20", "09:21", SOUTH, WALKING, "alva_traveler3", "alva_traveler2"),
        SchedulePart("alva_road_west", "09:21", "09:24", EAST,  WALKING, "alva_traveler2", "alva_traveler1")
        // @formatter:on
    )
