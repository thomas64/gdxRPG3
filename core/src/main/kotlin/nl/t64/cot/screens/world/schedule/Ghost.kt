...
class Ghost : EntitySchedule() {
    ...
    override val scheduleParts: List<SchedulePart> = listOf(
        ...
        SchedulePart("lastdenn_house_garrin", "09:07", "09:16", NORTH, CRAWLING, "ghost2",  "ghost3",  "paton_hiding_behind_garrin2"),
        SchedulePart("lastdenn_house_garrin", "09:16", "09:20", EAST,  CRAWLING, "ghost3",  "ghost4",  "paton_hiding_behind_garrin2"),
        SchedulePart("lastdenn_house_garrin", "09:20", "09:28", SOUTH, CRAWLING, "ghost4",  "paton4",  "ghost_scaring2"),
        SchedulePart("lastdenn_house_garrin", "09:28", "09:35", EAST,  CRAWLING, "paton4",  "paton5",  "ghost_scaring2"),
        SchedulePart("lastdenn_house_garrin", "09:35", "09:43", NORTH, CRAWLING, "paton5",  "garrin4", "ghost_scaring2"),
        SchedulePart("lastdenn_house_garrin", "09:43", "09:54", WEST,  CRAWLING, "garrin4", "garrin6", "ghost_scaring2"),
        // @formatter:on
    )
    ...
    override fun handleSideEffects() {
        if (mapManager.currentMap.mapTitle == "lastdenn_house_garrin") {
            with(gameData.clock) {
                when {
                    isCurrentTimeAfter("10:00") && "!is_garrin_possessed".isTrue() ->
                        audioManager.fadeBgmAndPlayBgm(AudioEvent.BGM_GHOST, AudioEvent.BGM_HOUSE)
