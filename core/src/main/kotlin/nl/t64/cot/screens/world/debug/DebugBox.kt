...
//        table.add("").row();
        ...
        table.add("elder quest current:")
        table.add(gameData.quests.getQuestById("quest_honeywood_elder").currentState.toString())
        table.add("").row()
        table.add("elder quest reset:")
        table.add(gameData.quests.getQuestById("quest_honeywood_elder").resetState.toString())
        table.add("").row()
        table.add("quest0003:")
