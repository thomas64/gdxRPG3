...
class SceneHoneywoodFarmAttack3 : CutsceneScreen() {
    ...
    override fun prepare() {
        ...
        actions = listOf(thirdOrcAttacks())
    }

    private fun thirdOrcAttacks(): Action {
        return Actions.sequence(
            Actions.run {
                ...
                luana.direction = Direction.EAST
            ...
            Actions.addAction(Actions.sequence(
                ...
                Actions.delay(1f),
                Actions.run { orc3.direction = Direction.EAST },
                Actions.delay(0.5f),
                Actions.run { orc3.direction = Direction.WEST },
                Actions.delay(0.5f),
                Actions.run { orc3.direction = Direction.EAST },
                ...
                Actions.run { orc3.direction = Direction.WEST },
                Actions.delay(1f),
                Actions.run { orc3.entityState = EntityState.RUNNING },
                Actions.parallel(
                    actionMoveBy(orc3, -528f, -48f, 3.5f, FAST_STEP),
                    Actions.sequence(
                        Actions.delay(3f),
    ...
    override fun onNotifyBattleWon(battleId: String, spoils: Loot) {
        screenManager.setScreen(ScreenType.SCENE_HONEYWOOD_FARM_ATTACK_AFTER_WIN)
        SpoilsCutsceneScreen.load(spoils, ScreenType.SCENE_HONEYWOOD_FARM_ATTACK_AFTER_WIN)
    }
