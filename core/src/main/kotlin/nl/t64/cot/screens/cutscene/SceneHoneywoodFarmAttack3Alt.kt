...
class SceneHoneywoodFarmAttack3Alt : CutsceneScreen() {
    ...
    private fun thirdOrcAttacks(): Action {
        return Actions.sequence(
            ...
            Actions.addAction(Actions.sequence(
                ...
                Actions.parallel(
                    actionMoveBy(orc3, -528f, -72f, 3.5f, FAST_STEP),
                    Actions.sequence(
                        Actions.delay(3f),
    ...
    override fun onNotifyBattleWon(battleId: String, spoils: Loot) {
        screenManager.setScreen(ScreenType.SCENE_HONEYWOOD_FARM_ATTACK_AFTER_WIN_ALT)
