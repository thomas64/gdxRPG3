...
class SceneHoneywoodFarmAttack2 : CutsceneScreen() {
    ...
    private fun secondOrcAttacks(): Action {
        return Actions.sequence(
            ...
            Actions.addAction(Actions.sequence(
                ...
                Actions.parallel(
                    actionMoveBy(orc2, -384f, -48f, 2.5f, FAST_STEP),
                    Actions.sequence(
                        Actions.delay(2f),
    ...
    override fun onNotifyBattleWon(battleId: String, spoils: Loot) {
        screenManager.setScreen(ScreenType.SCENE_HONEYWOOD_FARM_ATTACK_3)
        SpoilsCutsceneScreen.load(spoils, ScreenType.SCENE_HONEYWOOD_FARM_ATTACK_3)
    }
